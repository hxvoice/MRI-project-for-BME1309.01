...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--no-show",
        action="store_true",
        help="Deprecated compatibility flag; previews are saved without popups by default.",
    )
    parser.add_argument("--show", action="store_true", help="Open an interactive popup window after saving the preview.")
...
def main() -> None:
    ...
    configure_pyplot(show=show_preview)
    ...
    save_preview(preview_data, preview_path, show=show_preview)
